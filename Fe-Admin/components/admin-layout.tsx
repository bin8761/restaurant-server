...
const menuItems = [
  ...
  { title: "Quản lý bàn", url: "/tables", icon: UtensilsCrossed },
  { title: "Đơn đặt bàn", url: "/reservations", icon: CalendarCheck },
  ...
  { title: "Định lượng", url: "/portioning", icon: Scale },
];
      ...
      <SidebarInset>
        <header className="flex h-14 items-center gap-4 border-b bg-background px-4">
          ...
          <div className="flex flex-1 items-center justify-between">
            <h1 className="text-lg font-semibold">{menuItems.find((item) => item.url === pathname)?.title || "Dashboard"}</h1>
